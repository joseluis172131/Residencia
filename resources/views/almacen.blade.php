    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex me-2" role="search" onsubmit="event.preventDefault(); searchTable();">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('almacen.update', ['id' => $item->id]) }}"
                                            ...
                                            <input type="text" class="form-control" id="codigo{{ $item->id }}" name="txtcodigo" 
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="subArea{{ $item->id }}"
                                                    ...
                                                    <option value="Distribución"
                                                        {{ $item->sub_area == 'Distribución' ? 'selected' : '' }}>
                                                        Distribución</option>
                                                    <option value="Herramientas de Prestacion"
                                                        {{ $item->sub_area == 'Herramientas de Prestacion' ? 'selected' : '' }}>
                                                        Herramientas de Prestacion</option>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="d-flex justify-content-between w-100 align-items-center">
                        <h1 class="modal-title fs-5" id="addModalLabel">Añadir</h1>

                        <!-- Icono relacionado con pailería -->
                        <i class="fa-solid fa-hammer" style="font-size: 24px; color: black;"></i>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                </div>
                <div class="modal-body">
                    <form id="addForm" action="{{ route('almacen.create') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="addNombreHerramienta" class="form-label">Nombre</label>
                        ...
                        <input class="form-check-input" type="radio" id="estatusDisponible" name="txtestatus" value="Disponible" required>
                        <label class="form-check-label" for="estatusDisponible">Disponible</label>
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="estatusOcupado" name="txtestatus" value="Ocupado" required>
                     <label class="form-check-label" for="estatusOcupado">Ocupado</label>
                    </div>
                   </div>
                  </div> 
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="addSubArea" name="txtsubarea" required>
                                ...
                                <option value="Herramientas de Prestacion">Herramientas de Prestacion</option>
                                <option value="Herramientas de Instalacion">Herramientas de Instalacion</option>
                            </select>
                        </div>
                        <div class="mb-3">
