                        ...
                        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('Ingenieria.update', ['id' => $item->id]) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="subArea{{ $item->id }}"
                                                    ...
                                                    <option value="Herramienta"
                                                        {{ $item->sub_area == 'Herramienta' ? 'selected' : '' }}>
                                                        Herramienta </option>
                                                    ...
                                                    <option value="Equipo de Computo"
                                                        {{ $item->sub_area == 'Equipo de Computo' ? 'selected' : '' }}>
                                                        Equipo de Computo </option>
                                                    <option value="Mobiliario"
                                                        {{ $item->sub_area == 'Mobiliario' ? 'selected' : '' }}>
                                                        Mobiliario</option>
                                                    <option value="Equipo Variable"
                                                        {{ $item->sub_area == 'Equipo Variable' ? 'selected' : '' }}>
                                                        Equipo Variable</option>
                                                    <option value="Papeleria"
                                                        {{ $item->sub_area == 'Papeleria' ? 'selected' : '' }}>
                                                        Papeleria</option>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('Ingenieria.destroy', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" action="{{ route('Ingenieria.create') }}" method="POST"
                     ...
                     <label class="form-check-label" for="estatusOcupado">Ocupado</label>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="addSubArea" name="txtsubarea" required>
                                ...
                                <option value="Equipo Variable">Equipo Variable</option>
